...
export default function Settings() {
  ...
  return (
    <div className="w-[24rem] bg-black border-r border-gray-800 min-h-screen">
      {/* Header */}
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="space-y-2">
          ...
          <button
            ...
            className="w-full flex items-center justify-between  hover:bg-[#262626] px-4 py-3 rounded-lg transition-colors duration-200 group"
          >
            <span className="text-sm text-gray-100">Edit profile</span>
          ...
          <button
            ...
            className="w-full flex items-center justify-between  hover:bg-[#262626] px-4 py-3 rounded-lg transition-colors duration-200 group"
          >
            <span className="text-sm  text-gray-100">Account privacy</span>
            <ChevronRight size={18} className="text-gray-500  group-hover:text-gray-400 transition-colors" />
          </button>
        </div>
      </div>
