      ...
      <div className="flex-1 flex justify-center gap-4">
        ...
        <div className="w-full md:w-1/2 lg:w-2/5 flex items-center justify-center px-4 py-8">
          <div className="w-full max-w-lg flex flex-col items-center justify-center">
            <div className="bg-black border w-[80%] border-gray-700 rounded-sm p-8 mb-4">
              ...
              <p className="text-center text-gray-400 text-sm mb-6">
                Sign up to connect with your FAST university community.
              </p>

              <button className="w-full bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded mb-4 flex items-center justify-center space-x-2">
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <select
                    ...
                    onChange={handleInputChange}
                    required
                    className="w-full px-3 py-2 bg-[#121212] border border-gray-600 rounded-sm text-white text-sm focus:outline-none focus:border-gray-400"
                  >
                ...
                <p className="text-xs text-gray-412 text-center mt-4">
                  People who use our service may have uploaded your contact information to FastGram.{' '}
